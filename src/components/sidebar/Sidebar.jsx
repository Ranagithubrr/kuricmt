...
const Sidebar = ({ sidebar, setSidebar }) => {
    ...
    return (
        <>
            <div className={`${!sidebar ? 'w-8/12 lg:w-3/12' : 'w-[6rem] -left-full lg:left-0'} lg:z-auto h-full fixed lg:sticky transition-all duration-300 ease-in-out overflow-y-scroll pb-10 dark:border-gray-700 border-r shadow-lg dark:shadow-transparent bg-white dark:bg-slate-800 z-50`}>
                ...
                <ul className='pl-2 pt-2 top-0 mb-12 lg:mb-0'>
