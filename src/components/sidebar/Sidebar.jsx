                ...
                }
                {
                    ...
                    <li className='flex  hover:bg-slate-200 rounded dark:hover:bg-gray-700'>
                        <Link to='/dashboard/add-announcement' className='h-full w-full  py-4 px-2 block'>
                            <span className='flex items-center text-base dark:text-gray-300'><GrAnnounce className='text-xl' />  <span className='pl-3 h-full text-sm font-semibold'>Announcement</span></span>
                        </Link>
                    </li>
                }
