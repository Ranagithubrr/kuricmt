              ...
              Teachers.map((ele) => {
                if (ele.type !== "admin") {
                  return (
                    <div
                      data-aos="fade-up"
                      className="border rounded cursor-pointer box-border overflow-clip pb-4"
                    >
                      <div className="h-32 bg-gradient-to-r from-gray-200 via-gray-300 to-gray-400"></div>
                      <div>
                        <img
                          src={ele.image || ProfilePIc}
                          alt=""
                          className="rounded-full h-32 w-32 m-auto -mt-16 ring ring-white"
                        />
