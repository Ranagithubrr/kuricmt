...
const Gallery = () => {
    return (
        <div>
            ...
            <div class="w-full  p-5 pb-10 mx-auto mb-10 gap-5 columns-3 space-y-5">
                ...
                <img src="https://placekitten.com/350/500" alt="5" class="w-full" />
                <img src="https://placekitten.com/300/400" alt="2" class="w-full" />
                <img src="https://placekitten.com/400/300" alt="1" class="w-full" />
                <img src="https://placekitten.com/350/500" alt="7" class="w-full" />
            </div>
