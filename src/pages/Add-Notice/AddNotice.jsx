...
const AddNotice = () => {
  ...
  return (
    <div className='p-4 flex items-center justify-center h-80 flex-col mt-20'>
      ...
      <input type="text" value={title} placeholder='Notice Title' className='border outline-none w-1/2 rounded-sm px-2 py-2 my-2 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300'
        onChange={(e) => setTitle(e.target.value)}
      />
      <input type="text" value={description} placeholder='Notice Descrition' className='border outline-none w-1/2 rounded-sm px-2 py-2 my-2 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300'
